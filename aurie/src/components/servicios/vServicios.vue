    ...
    <div class="contents">
      ...
      <div class="right">
        <div class="portrait">
          ...
          <div class="text-card">
            <p>
              Ábrete puertas a un camino en el que podrás descubrir cosas que nunca antes habrías imaginado.
            </p>
          </div>
...
.portrait-img {
  ...
  width: 100%;
  z-index: 3;
  background: url('@/assets/images/retrato_servicios.webp');
